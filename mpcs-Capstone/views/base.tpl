      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          %else:
            ...
            <li><a href="{{get_url('annotate')}}">Submit Job</a></li>
	    <li><a href="/">Home</a></li>
	    <li class="dropdown">
   		 <a href="#" class="dropdown-toggle" data-toggle="dropdown">{{auth._beaker_session.get('username')}}<b><span class="caret"></span></b></a>
